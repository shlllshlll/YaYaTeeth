...
_TEETH_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 7309,  # num of samples in images/training
        'val': 1827,    # num of samples in images/validation
        'trainval': 9137,
    },
    num_classes=3,
    ignore_label=255,
...
_TEETH4_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 7309,  # num of samples in images/training
        'val': 1827,    # num of samples in images/validation
        'trainval': 9137,
...
_TEETH21_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 7309,  # num of samples in images/training
        'val': 1827,    # num of samples in images/validation
        'trainval': 9137,
...
_DATASETS_INFORMATION = {
    ...
    'teeth': _TEETH_INFORMATION,
    'teeth4': _TEETH4_INFORMATION,
    'teeth21': _TEETH21_INFORMATION
}
